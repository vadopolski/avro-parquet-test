...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7198811679135180268L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Customer\",\"namespace\":\"com.example\",\"fields\":[{\"name\":\"first_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"First Name of Customer\"},{\"name\":\"last_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Last Name of Customer\"},{\"name\":\"height\",\"type\":\"float\",\"doc\":\"Height at the time of registration in cm\"},{\"name\":\"weight\",\"type\":\"float\",\"doc\":\"Weight at the time of registration in kg\"},{\"name\":\"automated_email\",\"type\":\"boolean\",\"doc\":\"Field indicating if the user is enrolled in marketing emails\",\"default\":true}],\"version\":\"1\"}");
   ...
   */
  public Customer(String first_name, String last_name, Float height, Float weight, Boolean automated_email) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: height = (Float)value$; break;
    case 3: weight = (Float)value$; break;
    case 4: automated_email = (Boolean)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
    ...
    public Customer build() {
      try {
        ...
        record.height = fieldSetFlags()[2] ? this.height : (Float) defaultValue(fields()[2]);
        record.weight = fieldSetFlags()[3] ? this.weight : (Float) defaultValue(fields()[3]);
        record.automated_email = fieldSetFlags()[4] ? this.automated_email : (Boolean) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
